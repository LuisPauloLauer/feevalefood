        ...
        <div class="accountbox__inner tab-content" id="myTabContent">
            ...
            <ul class="nav accountbox__filters" id="myTab" role="tablist">
                <li>
                 ...
                 <li>
                    <a id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Email</a>
                </li>
            </ul> -->
        ...
        @if( Session::has('userSiteData') )
            <div class="accountbox__register">
                ...
                <form class="form-signin" action="{{ route('usersite.store') }}" method="post" name="formUserSiteCad">
                    ...
                    @endif
                    <div class="input-group mb-3">
                        <input id="idphoneAddUser" name="fone" type="text" class="form-control" placeholder="Ex.: (51) 98888-8888" autofocus>
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    @if( Session::has('universityBuildings') )
                        ...
                        <div class="input-group mb-3">
                            <select id="idBuildingAddUser" name="building" size="5" data-placeholder="selecione uma empresa..." class="custom-select chosen-select">
                                <option value=""></option>
