...
.htc__header .header__right .nav-link {
    padding: 0;
}
...
.mainmenu__wrap__checkout .logo a {
    height: 80px;
}
...
.mainmenu__wrap.mainmenu__wrap__checkout {
    box-shadow: 0 2px 3px rgba(0, 0, 0, 0.2);
    transition: box-shadow 0.5s ease-in-out 0s;
    left: 0;
    top: 0;
...
.copyright .copyright__inner .copyright__inner_img {
    width: 100px;
    margin-left: 5px;
}
...
.opening__time__list .time__list__day {
    margin: 0;
    width: 25%;
    float: left;
}

.opening__time__list .time__list__day2 {
    margin: 0;
    width: 25%;
    float: left;
}

.opening__time__list .time__list__separator {
    padding: 0 15px;
}

.opening__time__list .time__list__time {
    padding: 0 12px;
}

.opening__time__list .time__list__time2 {
    padding: 0 2px;
}
...
.single__sm__post .sin__post__thumb .lst__post__list__img {
    width: 77px;
    height: 70px;
}
...
.adduser-wrapper.is-visible .accountbox {
    transform: translate(-50%, -50%);
    opacity: 1;
    visibility: visible;
}
...
.adduser-wrapper.is-visible .body-overlay {
    opacity: 0.85;
    visibility: visible;
    z-index: 21;
}
...
.accountbox__login__email{
    padding-top: 15px;
    padding-left: 50px;
    padding-right: 50px;
}

.accountbox__login__mdsocial{
    padding-left: 50px;
    padding-right: 50px;
}

.accountbox__register__final{
    padding-left: 50px;
    padding-right: 50px;
}
...
@media only screen and (min-width: 768px) and (max-width: 991px) {
    ...
    .adduser-wrapper .accountbox .accountbox-close-button {
        left: auto;
        right: 0;
    }
...
.cartbox__item__edit.disabled, .cartbox__item__edit:disabled {
    cursor: not-allowed;
}
...
button.cartbox__item__edit:hover {
    color: #d50c0d;
}
...
.checkout-site-form .input-box input {
    width: 100%;
    border: 1px solid #ededed;
...
.checkout-site-form .input-box input[type=submit] {
    width: 120px;
    margin-right: 0;
    background-color: #d50c0d;
    padding: 8px 15px;
...
.checkout-site-form .input-box input[type=submit]:hover {
...
.checkout-delivery-form .input-box input {
    width: 100%;
    border: 1px solid #ededed;
    background-color: #ffffff;
    height: 40px;
...
.checkout-delivery-form .input-box input[type=submit] {
    width: 120px;
    margin-right: 0;
    background-color: #d50c0d;
    padding: 8px 15px;
...
.checkout-delivery-form .input-box input[type=submit]:hover {
    background-color: #bd0b0c;
}
...
.special__food__menu .fd__tab__content .single__tab__panel .tab__content__wrap .single__tab__content .food__menu .food__menu__thumb a img {
    width: 109px;
    height: 105px;
    border-radius: 8px;
}

.food__menu:hover .food__menu__thumb a img {
    transform: scale(1.10);
    z-index: 1;
}

a .view-product-info:not(:disabled):not(.disabled) {
    cursor: pointer;
}
...
.modal-product-content-info .modal-product-description {
    display: inline-block;
    font-size: 0.9rem;
    padding-top: 0px;
    margin: 0;
...
.modal-product-content-info .modal-product-content-list {
    margin-top: 12px;
}
...
.modal-product-price .modal-product-price-text {
    color: #50a773;
    margin-bottom: 10px;
}

.modal-product-obs .modal-product-obs-content {
    display: block;
}

.modal-product-obs .modal-product-obs-content .modal-product-obs-title {
    display: flex;
    justify-content: space-between;
    align-items: center;
    width: 100%;
...
.modal-product-obs .modal-product-obs-content .modal-product-obs-title .modal-product-obs-lbl {
    margin: 0;
    font-weight: 600;
    font-size: 1rem;
    color: #717171;
...
.modal-product-obs .modal-product-obs-content .modal-product-obs-title .modal-product-obs-span {
    color: #a6a6a6;
    font-weight: 100;
    font-size: 1rem;
}

.modal-product-obs .modal-product-obs-content .modal-product-obs-txt {
    border-radius: 4px;
...
.modal-product-obs .modal-product-obs-content p {
    height: 4px;
    margin-top: 2px;
    background-color: #ccc
}

.fd__testimonial__area .fd__testimonial__container .single__testimonial {
    min-height: 215px;
}
...
@media only screen and (min-width: 960px) {
    ...
    .modal-product-obs .modal-product-obs-content .modal-product-obs-txt::-moz-placeholder {
        color: #a6a6a6;
        opacity: 1;
        font-weight: 100;
    }

    .modal-product-obs .modal-product-obs-content .modal-product-obs-txt:-ms-input-placeholder {
        color: #a6a6a6;
        opacity: 1;
        font-weight: 100;
    }

    .modal-product-obs .modal-product-obs-content .modal-product-obs-txt::placeholder {
        color: #a6a6a6;
        opacity: 1;
        font-weight: 100;
    }
...
@media only screen and (min-width: 480px) and (max-width: 767px) {
    ...
    .modal-product-view-body .modal-product-content-info {
        margin-top: 20px;
    }
...
@media only screen and (max-width: 575px) {
    ...
    .htc__header .header__right .log__in button {
        height: 25px;
    }
